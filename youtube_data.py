...
DEVELOPER_KEY = "AIzaSyDxJbSEPodYNzB6Fuk4hsZHnwH08J8uc1I"
YOUTUBE_API_SERVICE_NAME = "youtube"
YOUTUBE_API_VERSION = "v3"

# start_time = datetime(year=2020,month=5,day=10).strftime('%Y-%m-%dT%H:%M:%SZ')
# end_time = datetime(year=2006,month=5,day=12).strftime('%Y-%m-%dT%H:%M:%SZ')
...
def youtube_search(q, max_results=50,order="relevance", token=None, location=None, location_radius=None):
    ...
    for search_result in search_response.get("items", []):
        if search_result["id"]["kind"] == "youtube#video":
            ...
            publishedAt.append(search_result['snippet']['publishedAt']) 
